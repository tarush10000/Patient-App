...
class WhatsBoostService {
  constructor() {
    this.appkey = process.env.WHATSBOOST_APP_KEY || '0a1375d1-500c-4f2e-afac-a4a9fa449840';
    this.authkey = process.env.WHATSBOOST_AUTH_KEY || 'C1y84SZLTbJlIUiImYDtrGfQx2jPmXPvUkbLf8ZPisZDriABRT';
